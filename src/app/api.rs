...
impl App {
    ...
    pub(crate) fn handle_api_request_after_internal_events_drained(
        ...
        let response = match request.method {
            ...
            Method::LayoutEqualize(params) => {
                return self.handle_layout_equalize(request.id, params);
            }
            ...
            Method::PaneCommandOutput(params) => {
                return self.handle_pane_command_output(request.id, params);
            }
